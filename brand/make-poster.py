...
.brandrow{display:flex;align-items:center;gap:.16in;margin-bottom:.5in}
...
.plate{background:#fff;border-radius:.3in;padding:.26in;
  box-shadow:0 .18in .5in rgba(0,0,0,.30)}
